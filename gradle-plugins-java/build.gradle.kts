...
gradlePlugin {
  ...
  plugins {
    create("java") {
      ...
      description = "Core plugin for internal Java subprojects. " +
        "Applies java-library, JaCoCo, and Spotless (Google Java Format). " +
      ...
      tags = listOf("convention", "java", "jacoco", "spotless")
    }
  }
}
