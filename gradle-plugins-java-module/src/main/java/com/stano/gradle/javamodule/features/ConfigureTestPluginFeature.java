...
public class ConfigureTestPluginFeature implements PluginFeature {
  ...
  public void apply(Project project) {
    ...
    testTask.jvmArgs("--add-opens", "java.base/java.lang=ALL-UNNAMED", "-Dhttp.agent=wtf", "-Xshare:off");
    ...
    testTask.systemProperty("pact.provider.branch", rootExtension.getBranchNameProvider().toString());
