...
import com.stano.gradle.base.changecase.ConstantCase;
import java.io.File;
...
public class GradlePluginUtil {
  ...
  public static String getNestedProjectName(Project project) {
    ...
    try {
      ...
      extensionContextName = baseExtension.getContextName();
    } catch (Exception ex) {
      project
          .getLogger()
          .lifecycle("BaseExtension contextName not found on project: " + project.getName());
    }
