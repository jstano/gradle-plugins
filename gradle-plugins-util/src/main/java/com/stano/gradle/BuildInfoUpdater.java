...
public class BuildInfoUpdater {
   ...
   public static void updateYmlWithBuildInfo(RootExtension rootExtension, String version, BuildInfoProvider buildInfoProvider, String applicationYmlPath) {
      ...
      if (applicationYmlFile.canRead()) {
         ...
         IOUtils.withWriter(applicationYmlFile, writer -> {
            try {
