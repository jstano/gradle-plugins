...
//      rootExtension.setDefaultNodeVersion(getDefaultNodeVersion(project));
   ...
   private static String getProjectProperty(Project project, String propertyName, String defaultValue) {
   ...
   private static String getProjectOrSystemProperty(Project project, String propertyName, String defaultValue) {
