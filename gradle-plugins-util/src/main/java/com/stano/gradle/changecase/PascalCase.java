...
public class PascalCase {
  /**
   * Transform into a string of capitalized words without separators. "test string" becomes
   * "TestString"
   *
  ...
  public static String pascalCase(String text) {
    return noCase(text, Options.options().withDelimiter("").withTransform(pascalCaseTransform));
  }
